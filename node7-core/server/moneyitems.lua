...
local initialized = {}
RegisterNetEvent('Node7Core:Server:OnPlayerLoaded')
AddEventHandler('Node7Core:Server:OnPlayerLoaded', function()
    local src = source
    local player = Node7Core.Functions.GetPlayer(src)
...
if Node7Core.Config.Money.EnableMoneyItems then
    ...
    AddEventHandler('Node7Core:Server:OnMoneyChange', function(src, moneytype, amount, operation, reason)
