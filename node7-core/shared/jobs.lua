...
Node7Shared.Jobs = {
    ...
    railroad = {
        name = 'railroad',
        label = 'NODE7 Railroad',
        type = 'railroad',
        defaultDuty = false,
        offDutyPay = false,
        grades = {
           ['0'] = { name = 'Trainee', payment = 5 },
           ['1'] = { name = 'Brakeman', payment = 15 },
           ['2'] = { name = 'Conductor', payment = 25 },
           ['3'] = { name = 'Senior Conductor', payment = 40 },
           ['4'] = { name = 'Railmaster', isboss = true, payment = 60 },
        },
    },
